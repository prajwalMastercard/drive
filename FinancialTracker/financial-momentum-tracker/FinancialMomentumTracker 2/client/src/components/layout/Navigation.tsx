          ...
          <nav className="flex overflow-x-auto hide-scrollbar" aria-label="Main Navigation">
            <a 
              ...
              onClick={(e) => {
                ...
                // Reset all calculator-related state when switching back to recommendations
                setActiveTab('recommendations');
                
                // Reset recommendation selection
                setSelectedRecommendation(null);
                
                // Reset calculated value to hide the results card
                setCalculatedValue(null);
                
                // Reset duration to 0 months as requested
                setDuration(0);
                
                // Directly reset all transaction types to empty array
                // This is more reliable than toggling them off one by one
                setSelectedTransactionTypes([]);
                
                // Log to console to confirm reset
                console.log('Value Calculator parameters completely reset to default.');
              }}
