import { propensityData, portfolioUsage, industryData, merchantData, scalingData } from '@/data/portfolioData';
...
const PropensityModels = () => {
  return (
    <>
      <h3 className="text-lg font-semibold mb-4">Propensity Models and Usage Analysis</h3>
