...
export const keyDrivers: KeyDriverData = {
  ...
  distribution: [
    { name: 'Card is Present', value: 35, color: '#EB001B' },
    { name: 'Card is Remote', value: 20, color: '#FF5F00' },
    { name: 'E-Commerce', value: 15, color: '#2196F3' },
    { name: 'ATM', value: 10, color: '#4CAF50' },
